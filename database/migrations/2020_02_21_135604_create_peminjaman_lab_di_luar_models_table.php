...
class CreatePeminjamanLabDiLuarModelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('peminjaman_lab_di_luar', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('peminjaman_lab_di_luar_models');
    }
}
