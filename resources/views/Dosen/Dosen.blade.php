@extends('../base')
@section('Title', 'Labkom FMIPA UNS | Data Dosen')
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button type="button" class="btn btn-tool">
                        <a href="{{ route('Dosen.create') }}" class="btn btn-warning btn-sm">
                    ...
                    @foreach($Dosen as $elemen)
                        <tr>
                            ...
                            <td class="project-actions text-right">
                                <a class="btn btn-primary btn-sm" href="/Dosen/{{ $elemen->id_dosen }}">
                                    <i class="fas fa-folder"></i>
                                    View
                                </a>
                                <a class="btn btn-info btn-sm" href="/Dosen/{{ $elemen->id_dosen }}/edit">
                                    <i class="fas fa-pencil-alt"></i>
                                    Edit
                                </a>
                                <form action="/Dosen/{{ $elemen->id_dosen }}" style="margin: 0; padding: 0; display: inline;" method="post">
                                    @csrf
                                    <a class="btn btn-danger btn-sm" href="/Dosen/{{ $elemen->id_dosen }}">
