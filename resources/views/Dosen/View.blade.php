...
@section('MainContent')
    <section class="content">
        <form action="/Dosen/{{ $Dosen->id_dosen }}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_dosen" id="Nama" class="form-control" placeholder="Masukkan nama" maxlength="100" disabled required="" value="{{ $Dosen->nama_dosen }}">
                            </div>
                            <!-- /.card-body -->
                        </div>
                        <!-- /.card -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-body">
                        <div class="card-tools" >
                            <a href="{{ route('Dosen.index') }}" class="btn btn-secondary btn-lg">Back</a>
                        </div>
                    </div>
                </div>
            </div>
