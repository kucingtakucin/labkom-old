    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Installasi & Service</h3>
                <div class="card-tools">
                    <button type="button" class="btn btn-tool">
                        <a href="{{ route('JasaInstallasi.create') }}" class="btn btn-warning btn-sm">
                    ...
                    @foreach($JasaInstallasi as $elemen)
                        <tr>
                            ...
                            <td class="project-actions text-right">
                                <a class="btn btn-primary btn-sm" href="/JasaInstallasi/{{ $elemen->id }}">
                                    <i class="fas fa-folder"></i>
                                    View
                                </a>
                                <a class="btn btn-info btn-sm" href="/JasaInstallasi/{{ $elemen->id }}/edit">
                                    <i class="fas fa-pencil-alt"></i>
                                    Edit
                                </a>
                                <form action="/JasaInstallasi/{{ $elemen->id }}" style="margin: 0; padding: 0; display: inline;" method="post">
                                    @method('delete')
                                    @csrf
