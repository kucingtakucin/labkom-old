            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button type="button" class="btn btn-tool">
                        <a href="{{ route('Mahasiswa.create') }}" class="btn btn-warning btn-sm">
                    ...
                    @foreach($Mahasiswa as $elemen)
                        <tr>
                            ...
                            <td class="project-actions text-right">
                                <a class="btn btn-primary btn-sm" href="/Mahasiswa/{{ $elemen->id_mahasiswa }}">
                                    <i class="fas fa-folder"></i>
                                    View
                                </a>
                                <a class="btn btn-info btn-sm" href="/Mahasiswa/{{ $elemen->id_mahasiswa }}/edit">
                                    <i class="fas fa-pencil-alt"></i>
                                    Edit
                                </a>
                                <form action="/Mahasiswa/{{ $elemen->id_mahasiswa }}" style="margin: 0; padding: 0;" method="post">
                                    @csrf
                                    <a class="btn btn-danger btn-sm" href="/Mahasiswa/{{ $elemen->id_mahasiswa }}">
