                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_mata_kuliah" id="Nama" class="form-control" placeholder="Masukkan nama mata kuliah" maxlength="100" required="" value="{{ $MataKuliah->nama_mata_kuliah }}">
                            </div>
                            <!-- /.card-body -->
                        </div>
                        <!-- /.card -->
