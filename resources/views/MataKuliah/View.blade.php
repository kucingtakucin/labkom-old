...
@section('MainContent')
    <section class="content">
        <form action="/MataKuliah/{{ $MataKuliah->id_mata_kuliah }}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" disabled name="nama_mata_kuliah" id="Nama" class="form-control" placeholder="Masukkan nama mata kuliah" maxlength="100" required="" value="{{ $MataKuliah->nama_mata_kuliah }}">
                            </div>
                            <!-- /.card-body -->
                        </div>
                        <!-- /.card -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-body">
                        <div class="card-tools" >
                            <a href="{{ route('MataKuliah.index') }}" class="btn btn-secondary btn-lg">Back</a>
                        </div>
                    </div>
                </div>
            </div>
