        ...
        <form action="/PeminjamanLab/DiLuar/{{ $PeminjamanLab->id }}" method="post">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" id="Nama" class="form-control" placeholder="Masukkan nama" maxlength="100" required="" value="{{ $PeminjamanLab->nama_mahasiswa }}" disabled>
                            </div>
                            <div class="form-group">
                                <label for="NIM">NIM :</label>
                                <input type="text" name="nim" id="NIM" class="form-control" placeholder="Masukkan NIM" maxlength="10" required="" value="{{ $PeminjamanLab->nim_mahasiswa }}" disabled>
                            </div>
                            <div class="form-group">
                                <label for="jenis_kelamin">Jenis Kelamin :</label>
                                <select name="jenis_kelamin" id="jenis_kelamin" class="custom-select" required disabled>
                            ...
                            <div class="form-group">
                                ...
                                <select name="program_studi" id="ProgramStudi" class="custom-select" disabled>
                                    <option selected>{{ $PeminjamanLab->nama_prodi }}</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="Angkatan">Angkatan :</label>
                                <select name="angkatan" id="Angkatan" class="custom-select" disabled>
                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="lab" id="Lab" class="custom-select" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="dosen_pengampu" id="Dosen" class="form-control" maxlength="100" required="" placeholder="Masukkan nama dosen pengampu" disabled value="{{ $PeminjamanLab->nama_dosen }}">
                            </div>
                            <div class="form-group">
                                <label for="MataKuliah">Mata Kuliah :</label>
                                <input type="text" name="mata_kuliah" id="MataKuliah" disabled class="form-control" maxlength="50" required placeholder="Masukkan mata kuliah" value="{{ $PeminjamanLab->nama_mata_kuliah }}">
                            </div>
                            <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-body">
                        <div class="card-tools" >
                            <a href="{{ route('DiLuar.index') }}" class="btn btn-secondary btn-lg">Back</a>
                        </div>
                    </div>
                </div>
            </div>
