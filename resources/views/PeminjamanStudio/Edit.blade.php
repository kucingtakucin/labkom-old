                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="id_mahasiswa" id="Nama" class="custom-select" required>
                                    <option selected value="{{ $PeminjamanStudio->id_mahasiswa }}">{{ $PeminjamanStudio->nama_mahasiswa }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="hari" id="Hari" class="form-control" placeholder="Masukkan hari" maxlength="10" required="" value="{{ $PeminjamanStudio->hari }}">
                            </div>
                            <div class="form-group">
                                <label for="Tanggal">Tanggal :</label>
                                <input type="text" name="tanggal" id="Tanggal" class="form-control" placeholder="Masukkan tanggal" maxlength="25" required="" value="{{ $PeminjamanStudio->tanggal }}">
                            </div>
                            <div class="form-group">
                                <label for="Waktu">Waktu :</label>
                                <input type="text" name="waktu" id="Waktu" class="form-control" placeholder="Masukkan waktu" maxlength="30" required="" value="{{ $PeminjamanStudio->waktu }}">
                            </div>
                            <div class="form-group">
                                <label for="Dosen">Dosen :</label>
                                <select name="id_dosen" id="Dosen" class="custom-select" required="" >
                                    <option selected value="{{ $PeminjamanStudio->id_dosen }}">{{ $PeminjamanStudio->nama_dosen }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="keperluan" id="Keperluan" cols="30" rows="4" placeholder="Masukkan keperluan" required>{{ $PeminjamanStudio->keperluan }}</textarea>
                            </div>
                        </div>
                        <!-- /.card-body -->
