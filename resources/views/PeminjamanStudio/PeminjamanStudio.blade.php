            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Peminjaman Studio</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Peminjaman Studio</h3>
                <div class="card-tools">
                    <button type="button" class="btn btn-tool">
                        <a href="{{ route('PeminjamanStudio.create') }}" class="btn btn-warning btn-sm">
            ...
            <div class="card-body p-0">
                <table class="table table-striped projects table-bordered dataTable">
                    ...
                    @foreach($PeminjamanStudio as $elemen)
                    <tr>
                        ...
                        <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm" href="/PeminjamanStudio/{{ $elemen->id }}">
                                <i class="fas fa-folder"></i>
                                View
                            </a>
                            <a class="btn btn-info btn-sm" href="/PeminjamanStudio/{{ $elemen->id }}/edit">
                                <i class="fas fa-pencil-alt"></i>
                                Edit
                            </a>
                            <form action="/PeminjamanStudio/{{ $elemen->id }}" style="margin: 0; padding: 0; display: inline;" method="post">
                                @method('delete')
                                @csrf
                                <a style="margin: 0; padding: 4px;" class="btn btn-danger btn-sm" href="/PeminjamanStudio/{{ $elemen->id }}">
