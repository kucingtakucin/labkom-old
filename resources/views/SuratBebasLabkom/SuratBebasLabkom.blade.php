            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button type="button" class="btn btn-tool">
                        <a href="{{ route('SuratBebasLabkom.create') }}" class="btn btn-warning btn-sm">
                ...
                <table class="table table-striped projects">
                    ...
                    <tr>
                        ...
                        <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm" href="/SuratBebasLabkom/{{ $elemen->id }}">
                                <i class="fas fa-folder"></i>
                                View
                            </a>
                            <a class="btn btn-info btn-sm" href="/SuratBebasLabkom/{{ $elemen->id }}/edit">
                                <i class="fas fa-pencil-alt"></i>
                                Edit
                            </a>
                            <form action="/SuratBebasLabkom/{{ $elemen->id }}" style="margin: 0; padding: 0; display: inline;" method="post">
                                @method('delete')
                                @csrf
